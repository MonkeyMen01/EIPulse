...
<template>
  ...
  <aside-bar>
    <drop-down title="福委會管理" iconName="shop-window" :items="[
             { name: '商品新增', path: '/mall/manage/product/save' },
             { name: '所有商品', path: '/mall/manage/product' },
             { name: '訂單管理', path: '/mall/manage/order' }
           ]" menuId="submenu6">
      <li class="nav-item">
...
<style>
section {
  margin-left: 300px; /* 與 aside 的寬度相同 */
}
