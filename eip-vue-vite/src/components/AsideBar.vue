...
<template>
  ...
  <div class="d-flex flex-column p-0 bg-dark text-white rounded-4 position-fixed"
       style="width: 250px; height: 100vh;overflow-y: auto;">
    <h3 class=" rounded-4 text-center " style="line-height: 2 ;background-color: black">EIPulse</h3>
    ...
    <button class=" btn btn-primary mt-auto" @click="logout">Logout</button>
  </div>
</template>
